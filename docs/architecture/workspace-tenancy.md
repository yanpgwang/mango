...
they may do, and then call Mango with the key for their Workspace. If enterprise
requirements later need finer policy, that layer can introduce OpenFGA or a
similar system without changing Mango resource semantics.
