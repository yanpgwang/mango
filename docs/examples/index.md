...
- [Coding-agent iteration](coding-agent-iterate.md): use the Python SDK to upload failing tests, follow a repair, download the result, and independently verify it through the explicitly transitional managed File/output path.
